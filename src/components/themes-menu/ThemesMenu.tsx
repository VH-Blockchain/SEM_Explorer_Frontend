...
const ThemesMenu: React.FC = () => {
    ...
    return (
        <div className="header-right-wrap">
            <Button className="nav-items btn b4-chain-btn" onClick={() => window.open("https://b4chain.io/",'_blank')}>Connect Wallet</Button>
            ...
            {/* <div className="cus-network-btn">
                <Button onClick={openModal}><img src={b4chainlogo} alt="chain-logo" /></Button>
                <ul className={isActive ? "active" : ""}>
                <li onClick={closeModal}><a className={isActive ? "active" : ""} href="/">B4Fire Testnet</a></li>
                    <Tooltip title="ComingSoon" placement="left-start" >
                        <li  onClick={closeModal}>B4Fire Mainnet</li>
                    </Tooltip>
